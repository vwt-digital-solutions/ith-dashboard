...
def make_global_figures(filter_selectie):
    ...
    if df.empty | df2.empty:
        raise PreventUpdate
    fig_p, fig_OHW, fig_pie, table, stats = generate_graph(category, df, df2, df_tot=None)
...
def make_category_figures(filter_selectie, category):
    ...
    fig_p, fig_OHW, fig_pie, table, stats = generate_graph(category, df, df2, df_tot)
...
def processed_data(df, df2, df_tot, version, category):
    ...
    if category == 'global':
        ...
        fac['Gefactureerd'] = [filter_fac(df[df['OHW_2019_11_01'] is not False], 0),
                               filter_fac(df[df['OHW_2019_11_12'] is not False], 1),
                               filter_fac(df[df['OHW_2019_11_26'] is not False], 2),
                               filter_fac(df[df['OHW_2019_12_23'] is not False], 3)]
        fac.set_index('Datum', inplace=True)
        fac = fac['Gefactureerd']

        pOHW = pd.DataFrame()
        pOHW['Datum'] = df['Datum_WF'].iloc[0]
        pOHW['pOHW'] = [df[df['OHW_2019_11_01'] is not False]['OHW_2019_11_01'].count()+10000,
                        df[df['OHW_2019_11_12'] is not False]['OHW_2019_11_12'].count()+10000,
                        df[df['OHW_2019_11_26'] is not False]['OHW_2019_11_26'].count()+10000,
                        df[df['OHW_2019_12_23'] is not False]['OHW_2019_12_23'].count()+10000]
        ...
        fac = pd.DataFrame()
        fac['Datum'] = df['Datum_WF'].iloc[0]
        fac['Gefactureerd'] = [filter_fac(df[(df_tot[category[0:4] + '_2019_11_01']) & (df['OHW_2019_11_01'] is not False)], 0),
                               filter_fac(df[(df_tot[category[0:4] + '_2019_11_12']) & (df['OHW_2019_11_12'] is not False)], 1),
                               filter_fac(df[(df_tot[category[0:4] + '_2019_11_26']) & (df['OHW_2019_11_26'] is not False)], 2),
                               filter_fac(df[(df_tot[category[0:4] + '_2019_12_23']) & (df['OHW_2019_12_23'] is not False)], 3)]
        fac.set_index('Datum', inplace=True)
        fac = fac['Gefactureerd']

        pOHW = pd.DataFrame()
        pOHW['Datum'] = df['Datum_WF'].iloc[0]
        pOHW['pOHW'] = [df[(df_tot[category[0:4] + '_2019_11_01']) & (df['OHW_2019_11_01'] is not False)]['OHW_2019_11_01'].count()+10000,
                        df[(df_tot[category[0:4] + '_2019_11_12']) & (df['OHW_2019_11_12'] is not False)]['OHW_2019_11_12'].count()+10000,
                        df[(df_tot[category[0:4] + '_2019_11_26']) & (df['OHW_2019_11_26'] is not False)]['OHW_2019_11_26'].count()+10000,
                        df[(df_tot[category[0:4] + '_2019_12_23']) & (df['OHW_2019_12_23'] is not False)]['OHW_2019_12_23'].count()+10000]
        pOHW.set_index('Datum', inplace=True)
        pOHW = pOHW['pOHW']
